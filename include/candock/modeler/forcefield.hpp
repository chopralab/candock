...
struct ForceField {
    ...
    bool has_kb_force_type(const std::string& aclass1,
                           const std::string& aclass2) const;
    bool has_atom_type(const int aclass1) const;
    bool has_bond_type(const std::string& aclass1,
                       const std::string& aclass2) const;
    bool has_angle_type(const std::string& aclass1, const std::string& aclass2,
                        const std::string& aclass3) const;
    bool has_dihedral_type(const std::string& aclass1,
                           const std::string& aclass2,
                           const std::string& aclass3,
                           const std::string& aclass4) const;
    bool has_improper_type(const std::string& aclass1,
                           const std::string& aclass2,
                           const std::string& aclass3,
                           const std::string& aclass4) const;
    ...
    bool residue_exists(const std::string& name) const {
        return residue_topology.count(name);
    }
};
std::ostream& operator<<(std::ostream& stream,
                         const ForceField::ResidueTopology& r);
