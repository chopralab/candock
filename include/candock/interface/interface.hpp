...
CANDOCK_EXPORT size_t receptor_atom_details(char* chain_ids, size_t* resi,
...
CANDOCK_EXPORT size_t ligand_atom_details(char* chain_ids, size_t* resi,
...
CANDOCK_EXPORT size_t initialize_ffield(const char* data_dir,
                                        double dist_cutoff);
CANDOCK_EXPORT size_t initialize_modeler(const char* platform,
                                         const char* precision,
                                         const char* accelerators);

CANDOCK_EXPORT float calculate_score();

CANDOCK_EXPORT size_t set_positions_ligand(const size_t* atoms,
                                           const float* positions, size_t size);
CANDOCK_EXPORT size_t set_positions_receptor(const size_t* atoms,
