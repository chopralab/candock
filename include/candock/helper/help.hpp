...
const set<string> nucleic_acids{{"NNN"},  // artificial for geo
                                {"A"},   {"T"},  {"G"},  {"C"},  {"U"},
                                {"DA"},  {"DT"}, {"DG"}, {"DC"}, {"DU"}};
const set<string> ions{
    {"LI"}, {"BE"},  {"NA"},  {"MG"}, {"AL"}, {"K"},   {"CA"},  {"CR"}, {"MN"},
    {"FE"}, {"FE2"}, {"CO"},  {"NI"}, {"CU"}, {"CU1"}, {"ZN"},  {"PD"}, {"PB"},
    {"RU"}, {"AG"},  {"CD"},  {"SN"}, {"SB"}, {"SR"},  {"CS"},  {"BA"}, {"PT"},
    {"AU"}, {"HG"},  {"UNK"}, {"BR"}, {"CL"}, {"F"},   {"IOD"}, {"D8U"}};
...
const IdatmInfoMap infoMap{
    ...
    {"P", {TrigonalBipyramidal, 5, "other phosphorus"}},  // Janez : see
                                                          // exception in
                                                          // compute_hydrogen
                                                          // (molecule.cpp)
