/* This is array2d.hpp and is part of CANDOCK
...
struct Array2d {
    ...
    Array2d(int SZ) : data(nullptr) { init(SZ, SZ); }

    Array2d(int SZI, int SZJ) : data(nullptr) { init(SZI, SZJ); }
...
struct Array2d<bool> {
   ...
   public:
    size_t get_szi() const { return szi; }
    size_t get_szj() const { return szj; }
    ...
    Array2d(size_t SZ) : data(nullptr) { init(SZ, SZ); }

    Array2d(size_t SZI, size_t SZJ) : data(nullptr) { init(SZI, SZJ); }
