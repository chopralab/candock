...
set_property(TARGET OpenMM PROPERTY IMPORTED_LOCATION ${CMAKE_INSTALL_PREFIX}/${CANDOCK_VERSION}/lib/${CMAKE_SHARED_LIBRARY_PREFIX}OpenMM${CMAKE_SHARED_LIBRARY_SUFFIX} )
add_dependencies(OpenMM OpenMM_Build)

set(OPENMM_INCLUDE_DIR ${CMAKE_INSTALL_PREFIX}/${CANDOCK_VERSION}/include)
set(OPENMM_LIBRARY ${CMAKE_INSTALL_PREFIX}/${CANDOCK_VERSION}/lib/${CMAKE_SHARED_LIBRARY_PREFIX}OpenMM${CMAKE_SHARED_LIBRARY_SUFFIX})
