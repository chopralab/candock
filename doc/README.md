...
### could not find mapping of docked seed to segment with same name ???

You generated the *top_seeds* folder with a different *seeds.pdb* file than the currently used *prepared_ligands.pdb* file.
