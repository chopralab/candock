...
namespace Interpolation {
	...
	vector<double> interpolate(const vector<double> &dataX, const vector<double> &dataY, const double step) {
        ...
        BSplineFit::BSplineFit ( const vector<double> &dataX, const vector<double> &dataY, const size_t k, const size_t ncoeffs) :
            n (dataX.size()),
