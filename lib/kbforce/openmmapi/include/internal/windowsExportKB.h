#ifndef OPENMM_WINDOWSEXPORTKB_H_
#define OPENMM_WINDOWSEXPORTKB_H_
 ...
 */
    ...
    #if defined(KB_BUILDING_SHARED_LIBRARY)
        #define OPENMM_EXPORT_KB __declspec(dllexport)
    #elif defined(KB_BUILDING_STATIC_LIBRARY) || defined(KB_USE_STATIC_LIBRARIES)
        #define OPENMM_EXPORT_KB
    #else
        #define OPENMM_EXPORT_KB __declspec(dllimport)   // i.e., a client of a shared library
    #endif
#else
    #define OPENMM_EXPORT_KB // Linux, Mac
#endif

#endif // OPENMM_WINDOWSEXPORTKB_H_
