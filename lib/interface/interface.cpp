...
size_t initialize_complex(const char* filename) {
    ...
    try {
        ...
        __receptor = std::unique_ptr<candock::molib::Molecules>(
            new candock::molib::Molecules);
        ...
        __gridrec = std::unique_ptr<candock::molib::Atom::Grid>(
            new candock::molib::Atom::Grid(__receptor->get_atoms()));

        parser::FileParser lpdb(filename, parser::docked_poses_only, 1);

        __ligand = std::unique_ptr<candock::molib::Molecules>(
            new candock::molib::Molecules);
...
size_t initialize_receptor(const char* filename) {
    ...
    try {
        candock::parser::FileParser rpdb(filename, candock::parser::first_model,
                                         1);
...
size_t receptor_bond_count() {
    ...
    try {
        candock::molib::BondSet bondset =
            candock::molib::get_bonds_in(__receptor->get_atoms());
        return bondset.size();
    } catch (std::exception& e) {
        __error_string =
...
size_t ligand_bond_count() {
    ...
    try {
        candock::molib::BondSet bondset =
            candock::molib::get_bonds_in(__ligand->get_atoms());
        return bondset.size();
    } catch (std::exception& e) {
        __error_string =
...
size_t initialize_ffield(const char* data_dir, double dist_cutoff) {
    ...
    try {
        ...
        __ffield = std::unique_ptr<candock::OMMIface::ForceField>(
            new candock::OMMIface::ForceField);
